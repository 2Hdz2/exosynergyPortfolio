    ...
    <section className="container mx-auto px-4 py-24 relative" id="milestones">
      ...
      <div className="text-center mb-20">
        <div className="inline-flex items-center justify-center mb-8">
          <Orbit className="w-12 h-12 text-cyan-400 animate-spin" style={{ animationDuration: '8s' }} strokeWidth={1.5} />
        </div>
        ...
        <p className="text-slate-300 max-w-5xl mx-auto text-lg font-light leading-relaxed">
          Here you can track the significant milestones achieved throughout our exoplanet research journey. These pivotal moments represent crucial stages of our project's progression, reflecting key achievements and scientific breakthroughs in our discovery systems.
        </p>
      </div>
